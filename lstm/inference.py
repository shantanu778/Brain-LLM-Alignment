...
if __name__ == '__main__':
    ...
    parser.add_argument("-l", "--len", type=int, help="Max Sequence Length to Generate")
    ...
    if args.char:
        vocab = json.load(open(f'{config["corpus_type"]}/{config["model_type"]}/{config["token_type"]}/models/{config["vocab"]}.pth', "r"))
    else:
