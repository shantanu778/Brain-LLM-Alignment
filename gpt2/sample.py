...
import torch
import tiktoken
from main import GPTConfig, GPT

# -----------------------------------------------------------------------------
init_from = 'resume' # either 'resume' (from an out_dir) or a gpt2 variant (e.g. 'gpt2-xl')
out_dir = 'functless/log' # ignored if init_from is not 'resume'
...
if init_from == 'resume':
    ...
    ckpt_path = os.path.join(out_dir, 'model_36359.pt')
